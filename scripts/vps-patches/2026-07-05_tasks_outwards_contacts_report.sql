-- 2026-07-05: employee task reports, contacts added_by, operations outwards
...
DO $$ BEGIN
  BEGIN
    EXECUTE 'ALTER PUBLICATION supabase_realtime ADD TABLE public.operations_outwards';
