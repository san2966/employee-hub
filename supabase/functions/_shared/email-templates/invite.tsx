...
const link = { color: 'hsl(217, 91%, 35%)', textDecoration: 'underline' }
const button = { backgroundColor: 'hsl(217, 91%, 35%)', color: '#ffffff', fontSize: '14px', borderRadius: '8px', padding: '12px 20px', textDecoration: 'none' }
